...
class CodableFeedStore {
    ...
    func deleteCachedFeed(completion: @escaping FeedStore.DeletingCompletion) {
...
class CodableFeedStoreTests: XCTestCase {
    ...
    func test_insert_overridesPreviouslyInsertedCacheValues() {
        ...
        let firstInsertionError = insert((uniqueExpenseFeed().local, Date()), to: sut)
    ...
    @discardableResult
    private func insert(_ cache: (feed: [LocalFeedExpense], timestamp: Date), to sut: CodableFeedStore) -> Error? {
